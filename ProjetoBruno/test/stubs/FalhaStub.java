...
/**
 * Simula os dados de uma falha real
 *
...
public class FalhaStub extends Falha {
     ...
     *
     * <p>
     * Estende a Falha real e sobrescreve apenas o necessario para SUBSTITUIR o
     * comportamento real por respostas controladas: setEstado() apenas ARMAZENA
     ...
     *
     * <p>
     * Trata-se de um stub: ele nao registra nem expoe interacoes (numero de
     * chamadas, etc.). A verificacao nos testes e feita exclusivamente pelo
